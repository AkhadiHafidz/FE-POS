...
const Editproduct = () => {
  ...
  const loadData = useCallback(async () => {
    const out = await axiosInstance.get(`/api/product/${id}`, {});
  ...
  const loadKategory = useCallback(async () => {
    const out = await axiosInstance.get("/api/category", {});
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const out = await axiosInstance.put(`/api/product/${id}`, formData, {
        headers: {
